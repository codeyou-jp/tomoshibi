    ...
    React.createElement(KeyboardAvoidingView, {
      ...
      React.createElement(View, { style: s.inputRow },
        React.createElement(TextInput, {
          style: [s.input, { height: Math.min(Math.max(44, ((input.match(/\n/g) || []).length + 1) * 24 + 20), 120) }],
          value: input,
...
var s = StyleSheet.create({
  ...
  input: { flex: 1, backgroundColor: '#F8F8F8', borderRadius: 22, paddingHorizontal: 16, paddingVertical: 11, color: '#000000', fontSize: 15, minHeight: 44, maxHeight: 120, outlineWidth: 0 },
